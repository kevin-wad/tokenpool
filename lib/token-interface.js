...
var tokenContractJSON = require('../app/assets/contracts/EticaRelease.json');
...
module.exports =  {
 ...
 async  update()
  ...
  getTokenContractAddress()
  {
    ...
    {
      return deployedContractInfo.networks.testnet.contracts.eticarelease.blockchain_address;
    }else if(this.pool_env == 'staging'){
      return deployedContractInfo.networks.staging.contracts.eticarelease.blockchain_address;
    }else{
      return deployedContractInfo.networks.mainnet.contracts.eticarelease.blockchain_address;
    }
